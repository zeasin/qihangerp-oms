...
public class SysMenuServiceImpl extends ServiceImpl<SysMenuMapper, SysMenu>
    ...
    public boolean checkMenuNameUnique(SysMenu menu) {
        ...
        List<SysMenu> sysMenus = menuMapper.selectList(new LambdaQueryWrapper<SysMenu>().eq(SysMenu::getParentId, menu.getParentId()).eq(SysMenu::getMenuName, menu.getMenuName()));
        if (StringUtils.isNotNull(sysMenus) && sysMenus.size()>0&&sysMenus.get(0).getMenuId().longValue() != menuId.longValue())
        {
