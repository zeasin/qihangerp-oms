...
import cn.qihangerp.open.pdd.domain.OmsPddWaybillAccount;
import cn.qihangerp.open.pdd.domain.bo.PddWaybillGetBo;
...
//        }
    ...
    public AjaxResult pullWaybillAccount(@RequestBody PddPullRequest params) throws Exception {
        if (params.getShopId() == null || params.getShopId() <= 0) {
            return AjaxResult.error(HttpStatus.PARAMS_ERROR, "参数错误，没有店铺Id");
        }
