...
import cn.qihangerp.open.jd.domain.OmsJdWaybillAccount;
import cn.qihangerp.open.jd.domain.bo.JdWaybillGetBo;
...
import cn.qihangerp.open.jd.service.OmsJdWaybillAccountService;
...
@AllArgsConstructor
@RestController
@RequestMapping("/jd/ewaybill")
public class JdWaybillController extends BaseController {
    ...
    public AjaxResult getWaybillAccountList(@RequestBody JdPullRequest params) throws Exception {
    ...
    public AjaxResult pullWaybillAccount(@RequestBody JdPullRequest params) throws Exception {
        if (params.getShopId() == null || params.getShopId() <= 0) {
            return AjaxResult.error(HttpStatus.PARAMS_ERROR, "参数错误，没有店铺Id");
        }
