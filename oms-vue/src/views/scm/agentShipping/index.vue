  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="子订单编号" prop="orderItemId">
          <el-input v-model="form.orderItemId" placeholder="请输入子订单编号" />
        </el-form-item>
        <el-form-item label="订单日期" prop="orderDate">
          <el-date-picker clearable
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        shopType: [
          { required: true, message: "店铺平台不能为空", trigger: "change" }
        ],
        supplierId: [
  ...
  methods: {
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            ...
            addAgentShipping(this.form).then(response => {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除供应商代发货编号为"' + ids + '"的数据项？').then(function() {
