...
public class TaoOrder implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getHasYfx() == null ? other.getHasYfx() == null : this.getHasYfx().equals(other.getHasYfx()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getHasYfx() == null) ? 0 : getHasYfx().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", hasYfx=").append(hasYfx);
